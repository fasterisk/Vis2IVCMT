function Vis2ReferenceTreeView(divID)
{
	...
	{	
		...
		context.strokeRect(nSelectionRectangle_X1, 
							nSelectionRectangle_Y1, 
							nSelectionRectangle_X2-nSelectionRectangle_X1, 
							nSelectionRectangle_Y2 - nSelectionRectangle_Y1);			
		}
